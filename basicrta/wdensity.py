...
class WDensityAnalysis(AnalysisBase):
    ...
    *delta* = 1 Å and stored as a :class:`Density` object in the attribute
    ...
    def __init__(self, atomgroup, weights, delta=1.0,
    ...
    def _prepare(self):
        ...
        self._arange = arange
        self._bins = bins
        self._grids = np.array([grid.copy() for _ in range(self.weights.shape[1])])
    ...
    def _single_frame(self):
        ...
        self._grids += self.weights[self._ts.frame]*h
